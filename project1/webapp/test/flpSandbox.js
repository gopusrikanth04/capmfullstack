		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsriproproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsriproproject1-display": {
								"semanticObject": "comsriproproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sri.pro.project1",
									"url": sap.ui.require.toUrl("com/sri/pro/project1")
								}
							}
						}
					}
